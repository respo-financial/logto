...
const types_1 = __nccwpck_require__(8030);
__exportStar(__nccwpck_require__(8030), exports);
...
const language_kit_1 = __nccwpck_require__(7523);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(4382), exports);
__exportStar(__nccwpck_require__(7611), exports);
__exportStar(__nccwpck_require__(8352), exports);
...
const zod_1 = __nccwpck_require__(3301);
const const_1 = __nccwpck_require__(4382);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(8520), exports);
...
const lodash_orderby_1 = __importDefault(__nccwpck_require__(5493));
...
const assertions_1 = __nccwpck_require__(102);
...
const assert_1 = __nccwpck_require__(1843);
...
__exportStar(__nccwpck_require__(1843), exports);
__exportStar(__nccwpck_require__(102), exports);
__exportStar(__nccwpck_require__(6626), exports);
__exportStar(__nccwpck_require__(3965), exports);
__exportStar(__nccwpck_require__(9982), exports);
__exportStar(__nccwpck_require__(1745), exports);
__exportStar(__nccwpck_require__(4994), exports);
__exportStar(__nccwpck_require__(9301), exports);
var lodash_orderby_1 = __nccwpck_require__(5493);
...
const lodash_pick_1 = __importDefault(__nccwpck_require__(8076));
var lodash_pick_2 = __nccwpck_require__(8076);
...
const env_1 = __nccwpck_require__(3965);
...
const connector_kit_1 = __nccwpck_require__(5987);
...
exports.defaultMetadata = {
    id: 'google-universal',
    target: 'google',
    platform: connector_kit_1.ConnectorPlatform.Universal,
    name: {
        en: 'Google',
        'zh-CN': 'Google',
        'tr-TR': 'Google',
 ...
 */
const connector_kit_1 = __nccwpck_require__(5987);
const essentials_1 = __nccwpck_require__(6411);
const got_1 = __importStar(__nccwpck_require__(3061));
...
const getAuthorizationUri = (getConfig) => async ({ state, redirectUri }) => {
    ...
    const queryParameters = new URLSearchParams({
        ...
        response_type: 'code',
        state,
        scope: constant_1.scope,
    });
    return `${constant_1.authorizationEndpoint}?${queryParameters.toString()}`;
};
const getAccessToken = async (config, codeObject) => {
    ...
    const httpResponse = await got_1.default.post(constant_1.accessTokenEndpoint, {
        form: {
        ...
        timeout: constant_1.defaultTimeout,
    });
    const result = types_1.accessTokenResponseGuard.safeParse((0, connector_kit_1.parseJson)(httpResponse.body));
    if (!result.success) {
        throw new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.InvalidResponse, result.error);
    }
    const { access_token: accessToken } = result.data;
    (0, essentials_1.assert)(accessToken, new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.SocialAuthCodeInvalid));
    return { accessToken };
};
...
const getUserInfo = (getConfig) => async (data) => {
    ...
    const config = await getConfig(constant_1.defaultMetadata.id);
    (0, connector_kit_1.validateConfig)(config, types_1.googleConfigGuard);
    const { accessToken } = await (0, exports.getAccessToken)(config, { code, redirectUri });
    try {
        const httpResponse = await got_1.default.post(constant_1.userInfoEndpoint, {
            headers: {
                authorization: `Bearer ${accessToken}`,
            },
            timeout: constant_1.defaultTimeout,
        });
        const result = types_1.userInfoResponseGuard.safeParse((0, connector_kit_1.parseJson)(httpResponse.body));
        if (!result.success) {
            throw new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.InvalidResponse, result.error);
        }
        ...
        return {
            id,
            avatar,
            email: (0, essentials_1.conditional)(email_verified && email),
            name,
        };
    }
    catch (error) {
...
const authorizationCallbackHandler = async (parameterObject) => {
    ...
    if (!result.success) {
        throw new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.General, JSON.stringify(parameterObject));
    }
    return result.data;
};
const getUserInfoErrorHandler = (error) => {
    if (error instanceof got_1.HTTPError) {
        ...
        if (statusCode === 401) {
            throw new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.SocialAccessTokenInvalid);
        }
        throw new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.General, JSON.stringify(rawBody));
    }
    throw error;
};
const createGoogleConnector = async ({ getConfig }) => {
    return {
        ...
        type: connector_kit_1.ConnectorType.Social,
        configGuard: types_1.googleConfigGuard,
        getAuthorizationUri: getAuthorizationUri(getConfig),
        getUserInfo: getUserInfo(getConfig),
    };
};
exports["default"] = createGoogleConnector;
...
exports.accessTokenResponseGuard = zod_1.z.object({
    access_token: zod_1.z.string(),
    scope: zod_1.z.string(),
    token_type: zod_1.z.string(),
});
exports.userInfoResponseGuard = zod_1.z.object({
    sub: zod_1.z.string(),
...
exports.authResponseGuard = zod_1.z.object({
    code: zod_1.z.string(),
