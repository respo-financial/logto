...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.repeat = exports.normalizeValueToStringArray = void 0;
...
const lodash_orderby_1 = __importDefault(__nccwpck_require__(7650));
const isSameArray = (array1, array2) => {
    if (array1.length !== array2.length) {
        return false;
    }
    const sortedA = (0, lodash_orderby_1.default)(array1);
    const sortedB = (0, lodash_orderby_1.default)(array2);
...
exports.hasChineseCharacter = hasChineseCharacter;
...
const assertions_1 = __nccwpck_require__(4017);
...
const conditionalString = (exp) => ((0, assertions_1.notFalsy)(exp) ? String(exp) : '');
...
const assert_1 = __nccwpck_require__(4563);
...
__exportStar(__nccwpck_require__(4938), exports);
...
var lodash_orderby_1 = __nccwpck_require__(7650);
...
const lodash_pick_1 = __importDefault(__nccwpck_require__(5002));
var lodash_pick_2 = __nccwpck_require__(5002);
...
const env_1 = __nccwpck_require__(3028);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const defer_to_connect_1 = __nccwpck_require__(8985);
...
const mimicResponse = __nccwpck_require__(4240);
...
const zlib = __nccwpck_require__(9796);
const mimicResponse = __nccwpck_require__(9021);
...
var once = __nccwpck_require__(9852);
...
const pump = __nccwpck_require__(1619);
const bufferStream = __nccwpck_require__(4776);
...
const http_timer_1 = __nccwpck_require__(629);
const cacheable_lookup_1 = __nccwpck_require__(6825);
const CacheableRequest = __nccwpck_require__(5442);
const decompressResponse = __nccwpck_require__(2269);
...
const QuickLRU = __nccwpck_require__(6664);
...
const http = __nccwpck_require__(3685);
const https = __nccwpck_require__(5687);
const resolveALPN = __nccwpck_require__(8826);
const QuickLRU = __nccwpck_require__(6664);
const Http2ClientRequest = __nccwpck_require__(2126);
const calculateServerName = __nccwpck_require__(7161);
const urlToOptions = __nccwpck_require__(3730);
...
const {Agent, globalAgent} = __nccwpck_require__(6838);
const IncomingMessage = __nccwpck_require__(994);
const urlToOptions = __nccwpck_require__(3730);
const proxyEvents = __nccwpck_require__(9067);
const isRequestPseudoHeader = __nccwpck_require__(5864);
const {
...
const http2 = __nccwpck_require__(5158);
const agent = __nccwpck_require__(6838);
const ClientRequest = __nccwpck_require__(2126);
const IncomingMessage = __nccwpck_require__(994);
const auto = __nccwpck_require__(3379);
...
var once = __nccwpck_require__(9852)
var eos = __nccwpck_require__(1014)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.defaultMetadata = exports.endpoint = void 0;
exports.endpoint = 'https://{{accountSID}}.api.infobip.com' + '/sms/2/text/advanced';
...
const essentials_1 = __nccwpck_require__(334);
...
const sendMessage = (getConfig) => async (data, inputConfig) => {
    ...
    const config = inputConfig ?? (await getConfig(constant_1.defaultMetadata.id));
    (0, connector_kit_1.validateConfig)(config, types_1.infobipSmsConfigGuard);
    const { accountSID, apiKey, templates, from, contentTemplateId, principalEntityId } = config;
    const template = templates.find((template) => template.usageType === type);
    (0, essentials_1.assert)(template, new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.TemplateNotFound, `Cannot find template for type: ${type}`));
    const parameters = {
        messages: [
            {
                from: from,
    ...
    //         : template.content,
    try {
        console.log(`API URL is ${constant_1.endpoint.replace(/{{accountSID}}/g, accountSID)}`);
        console.log(`Body is ${JSON.stringify(parameters)}`);
        return await got_1.default.post(constant_1.endpoint.replace(/{{accountSID}}/g, accountSID), {
            headers: {
        ...
        if (error instanceof got_1.HTTPError) {
            ...
            (0, essentials_1.assert)(typeof rawBody === 'string', new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.InvalidResponse));
            throw new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.General, rawBody);
        }
        throw error;
    }
};
const createInfobipSmsConnector = async ({ getConfig }) => {
    return {
        metadata: constant_1.defaultMetadata,
        type: connector_kit_1.ConnectorType.Sms,
        configGuard: types_1.infobipSmsConfigGuard,
        sendMessage: sendMessage(getConfig),
    };
};
exports["default"] = createInfobipSmsConnector;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.infobipSmsConfigGuard = void 0;
const zod_1 = __nccwpck_require__(8062);
const templateGuard = zod_1.z.object({
    usageType: zod_1.z.string(),
    content: zod_1.z.string(),
});
exports.infobipSmsConfigGuard = zod_1.z.object({
    accountSID: zod_1.z.string(),
    apiKey: zod_1.z.string(),
    from: zod_1.z.string(),
    contentTemplateId: zod_1.z.string(),
    principalEntityId: zod_1.z.string(),
    // fromMessagingServiceSID: z.string(),
    templates: zod_1.z.array(templateGuard),
});
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(8488);
